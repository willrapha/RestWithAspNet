...
using RestWithAspNetAuthentication.Business.Implementations;
using RestWithAspNetAuthentication.HyperMedia;
using RestWithAspNetAuthentication.Model.Context;
using RestWithAspNetAuthentication.Repository;
using RestWithAspNetAuthentication.Repository.Generic;
using RestWithAspNetAuthentication.Repository.Implementations;
using RestWithAspNetAuthentication.Security.Configuration;
using Swashbuckle.AspNetCore.Swagger;
using Tapioca.HATEOAS;

namespace RestWithAspNetAuthentication
{

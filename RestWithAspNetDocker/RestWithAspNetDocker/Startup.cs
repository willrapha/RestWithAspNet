...
using RestWithAspNetDocker.Business.Implementations;
using RestWithAspNetDocker.HyperMedia;
...
using RestWithAspNetDocker.Repository.Implementations;
using RestWithAspNetDocker.Security.Configuration;
using Swashbuckle.AspNetCore.Swagger;
using Tapioca.HATEOAS;

namespace RestWithAspNetDocker
{

...
using RestWithAspNetFiles.Business;
using RestWithAspNetFiles.Business.Implementations;
using RestWithAspNetFiles.HyperMedia;
using RestWithAspNetFiles.Model.Context;
using RestWithAspNetFiles.Repository;
using RestWithAspNetFiles.Repository.Generic;
using RestWithAspNetFiles.Repository.Implementations;
using RestWithAspNetFiles.Security.Configuration;
using Swashbuckle.AspNetCore.Swagger;
using Tapioca.HATEOAS;

namespace RestWithAspNetFiles
{

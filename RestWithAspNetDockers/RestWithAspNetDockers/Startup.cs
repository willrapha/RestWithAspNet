...
using RestWithAspNetDockers.Business;
using RestWithAspNetDockers.Business.Implementations;
using RestWithAspNetDockers.HyperMedia;
using RestWithAspNetDockers.Model.Context;
using RestWithAspNetDockers.Repository;
using RestWithAspNetDockers.Repository.Generic;
using RestWithAspNetDockers.Repository.Implementations;
using RestWithAspNetDockers.Security.Configuration;
using Swashbuckle.AspNetCore.Swagger;
using Tapioca.HATEOAS;

namespace RestWithAspNetDockers
{
